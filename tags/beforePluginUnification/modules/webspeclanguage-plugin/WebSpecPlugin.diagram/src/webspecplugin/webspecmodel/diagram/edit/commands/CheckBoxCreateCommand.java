...
public class CheckBoxCreateCommand extends EditElementCommand {
  ...
  protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
    CheckBox newElement = WebspecmodelFactory.eINSTANCE.createCheckBox();
   ...
   * @generated
   */
  protected void doConfigure(CheckBox newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
