 ...
 */
public class MetaMockFactoryTestCase extends MetaMockTestCase {
  ...
  private String url;
  private java.util.List<UIControl> controls;
  ...
  public void testCreateDatePicker() {
    ...
    this.assertUIControlFeatures(c);
    this.assertUIControlFeatures((UIControl) c.copy());
  ...
  public void testCreateList() {
    ...
    List c2 = (List) c.copy();
    this.assertUIControlFeatures(c2);
    this.assertUIControlFeatures((UIControl) c2.copy());
  ...
  public void testCreatePanel() {
    ...
    CompositeControl c2 = (Panel) c.copy();
    this.assertUIControlFeatures(c2);
    this.assertCompositeControlFeatures(c2);
  ...
  public void testCreateMetaMockModel() {
    MetaMockModel c = this.getFactory().createMetaMockModel();
    for (UIControl ctrl : this.controls)
  ...
  public void testCreateControlAnnotation() {
    ControlAnnotation ca = this.getFactory().createControlAnnotation(this.controls.get(0), "customId");
  ...
  public void testCreateCompositeControlAnnotation() {
    ...
    CompositeControlAnnotation cca = this.getFactory().createCompositeControlAnnotation(this.controls.get(0), "customId", tia, ra, gbla);
  ...
  private void assertControlAnnotationFeatures(MetaMockAnnotation a) {
    assertSame(this.controls.get(0), a.getControl());
  }
  
  private void assertUIControlFeatures(UIControl c) {
  ...
  private void assertCompositeControlFeatures(CompositeControl c) {
    assertEquals(this.containerId, c.getContainerId());
    for (UIControl cc : this.controls)
      c.addChild(cc);
