...
/**
 * An assertion of an expression
 * 
 * @author Esteban Robles Luna
 */
public class WebAssertExpression implements WebAssertion {

  private Expression expression;

  public WebAssertExpression(Expression expression) {
  ...
  public Object accept(WebTestItemVisitor webTestItemVisitor) {
    return webTestItemVisitor.visitWebAssertExpression(this);
  }
