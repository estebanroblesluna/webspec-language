...
public class EnumWordType implements UserType, ParameterizedType {
	...
	public void setParameterValues(final Properties parameters) {
		...
		final String identifierMethodName = parameters.getProperty(
				IDENTIFIER_METHOD, DEFAULT_IDENTIFIER_METHOD_NAME);
		...
		final String valueOfMethodName = parameters.getProperty(VALUEOF_METHOD,
