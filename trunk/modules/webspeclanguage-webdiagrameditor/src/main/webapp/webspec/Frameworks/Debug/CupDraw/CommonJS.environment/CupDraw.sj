...
p;9;Drawing.jt;7457;@STATIC;1.0;t;7438;DrawingSelectionChangedNotification = "DrawingSelectionChangedNotification";
...
{ with(self)
{
 return objj_msgSend(objj_msgSend(objj_msgSend(self, "model"), "propertyValue:",  "Show grid?"), "boolValue");
}
},["bool"]), new objj_method(sel_getUid("snapToGrid"), function $Drawing__snapToGrid(self, _cmd)
{ with(self)
{
 return objj_msgSend(objj_msgSend(objj_msgSend(self, "model"), "propertyValue:",  "Snap to grid?"), "boolValue");
}
},["bool"]), new objj_method(sel_getUid("floatingToolboxes"), function $Drawing__floatingToolboxes(self, _cmd)
{ with(self)
{
 return objj_msgSend(objj_msgSend(objj_msgSend(self, "model"), "propertyValue:",  "Floating toolboxes?"), "boolValue");
}
},["bool"]), new objj_method(sel_getUid("gridSize"), function $Drawing__gridSize(self, _cmd)
{ with(self)
{
 return objj_msgSend(objj_msgSend(objj_msgSend(self, "model"), "propertyValue:",  "Grid size"), "intValue");
}
...
},["void","id"]), new objj_method(sel_getUid("modelChanged"), function $Drawing__modelChanged(self, _cmd)
{ with(self)
{
 objj_msgSend(self, "computeBackgroundLayer");
...
p;14;DrawingModel.jt;720;@STATIC;1.0;t;702;{var the_class = objj_allocateClassPair(Model, "DrawingModel"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
...
{ with(self)
{
 ...
 objj_msgSend(self, "addProperty:value:",  "Name",  "");
 objj_msgSend(self, "addProperty:value:",  "Show grid?",  NO);
 objj_msgSend(self, "addProperty:value:",  "Grid size",  20);
 objj_msgSend(self, "addProperty:value:",  "Snap to grid?",  NO);
 objj_msgSend(self, "addProperty:value:",  "Floating toolboxes?",  YES);
 return self;
}
},["id"])]);
}
...
p;12;Connection.jt;5712;@STATIC;1.0;t;5693;{var the_class = objj_allocateClassPair(Polyline, "Connection"),
...
objj_registerClassPair(the_class);
class_addMethods(the_class, [new objj_method(sel_getUid("source"), function $Connection__source(self, _cmd)
{ with(self)
{
...
},["Figure"]), new objj_method(sel_getUid("initWithSource:target:"), function $Connection__initWithSource_target_(self, _cmd, aSourceFigure, aTargetFigure)
{ with(self)
{
 ...
 if (self) {
  ...
  _magnet1 = objj_msgSend(objj_msgSend(HandleMagnet, "alloc"), "initWithHandle:source:target:",  objj_msgSend(self, "handleAt:",  2),  _sourceFigure,  _targetFigure);
...
},["id","Figure","Figure"]), new objj_method(sel_getUid("drawRect:on:"), function $Connection__drawRect_on_(self, _cmd, rect, context)
{ with(self)
{
...
class_addMethods(meta_class, [new objj_method(sel_getUid("source:target:"), function $Connection__source_target_(self, _cmd, aSourceFigure, aTargetFigure)
{ with(self)
{
 return objj_msgSend(objj_msgSend(self, "new"), "initWithSource:target:",  aSourceFigure,  aTargetFigure);
}
...
p;13;LabelFigure.jt;2337;@STATIC;1.0;t;2318;{var the_class = objj_allocateClassPair(Figure, "LabelFigure"),
...
{ with(self)
{
 self = objj_msgSendSuper({ receiver:self, super_class:objj_getClass("LabelFigure").super_class }, "initWithFrame:", aFrame);
 if (self) {
...
},["id","CGRect",null]), new objj_method(sel_getUid("figureAt:"), function $LabelFigure__figureAt_(self, _cmd, aPoint)
{ with(self)
{
 var frame = objj_msgSend(self, "frame");
 if (CPRectContainsPoint(frame, aPoint)) {
...
},["void","CPPoint"]), new objj_method(sel_getUid("isSelectable"), function $LabelFigure__isSelectable(self, _cmd)
{ with(self)
{
 return true;
}
...
p;10;Polyline.jt;6398;@STATIC;1.0;t;6379;var CachedNotificationCenter = nil;
{var the_class = objj_allocateClassPair(Figure, "Polyline"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_points")]);
objj_registerClassPair(the_class);
...
},["id","CPArray"]), new objj_method(sel_getUid("addNewHandle:"), function $Polyline__addNewHandle_(self, _cmd, anIndex)
{ with(self)
{
...
{ with(self)
{
 ...
 if (_nameColumn == aTableColumn) {
  return objj_msgSend(model, "propertyNameAt:",  rowIndex);
 } else {
...
p;17;RectangleFigure.jt;2132;@STATIC;1.0;t;2113;{var the_class = objj_allocateClassPair(Figure, "RectangleFigure"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
...
{ with(self)
{
 return objj_msgSend(objj_msgSend(self, "alloc"), "initWithName:value:",  aPropertyName,  aValue);
}
},["Property","id","id"])]);
}
