...
public final class ANativefunctioncallValue extends PValue
{
    ...
    public ANativefunctioncallValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANativefunctioncallValue(
    ...
    {
        ((Analysis) sw).caseANativefunctioncallValue(this);
    }
