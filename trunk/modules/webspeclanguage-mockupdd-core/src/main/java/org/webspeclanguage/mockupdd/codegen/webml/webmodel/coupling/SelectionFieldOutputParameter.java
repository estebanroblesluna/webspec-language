 ...
 */
public class SelectionFieldOutputParameter extends SelectionFieldInputParameter {

  
  public SelectionFieldOutputParameter(String id, String name, SelectionField selectionField) {
