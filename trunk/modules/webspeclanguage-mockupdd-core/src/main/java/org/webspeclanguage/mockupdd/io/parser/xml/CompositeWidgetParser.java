 ...
 */
public class CompositeWidgetParser implements SuiParser<Element, SuiParserContext> {
  ...
  public Object parse(Element source, SuiParserContext parserContext, Object partiallyParsedObject) throws SuiParsingException {
    CompositeWidget cw = ((CompositeWidget) partiallyParsedObject);
    for (Object child : source.getChild("widgets", parserContext.getNamespace()).getChildren()) {
      cw.addChild((Widget) parserContext.parse((Element) child));
    }
    return cw;
  }
