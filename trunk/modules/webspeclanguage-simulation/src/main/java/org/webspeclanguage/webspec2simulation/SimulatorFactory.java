...
public abstract class SimulatorFactory {
	...
	public List<Simulator> getSimulators(DiagramImpl diagram, String homePath) {
	...
	private SimulationGenerationResult generateSimulations(DiagramImpl diagram, String homePath) {
