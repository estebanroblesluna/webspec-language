 ...
 * @generated
 */
public class NavigationPreconditionActionsEditPart extends LabelEditPart
  ...
  static {
    registerSnapBackPosition(
        WebspecmodelVisualIDRegistry
            .getType(org.webspeclanguage.plugin.webspecmodel.diagram.edit.parts.NavigationPreconditionActionsEditPart.VISUAL_ID),
        new Point(0, 40));
  }
   ...
   * @generated
   */
  public NavigationPreconditionActionsEditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new WebspecmodelParserProvider.HintAdapter(
          WebspecmodelElementTypes.Navigation_4001, getParserElement(),
          parserHint);
