...
import org.webspeclanguage.plugin.webspecmodel.diagram.edit.policies.TextFieldItemSemanticEditPolicy;
...
public class TextFieldEditPart extends ShapeNodeEditPart {
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof TextFieldNameEditPart) {
      ((TextFieldNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureWidgetName());
      return true;
    }
    return false;
  }
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(WebspecmodelVisualIDRegistry.getType(TextFieldNameEditPart.VISUAL_ID));
  }
