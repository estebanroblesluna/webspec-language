 ...
 * @generated
 */
public class OneOfNumbersViewFactory extends AbstractShapeViewFactory {
  ...
  protected void decorateView(View containerView, View view,
    ...
    if (semanticHint == null) {
      semanticHint = WebspecmodelVisualIDRegistry
          .getType(OneOfNumbersEditPart.VISUAL_ID);
    ...
    getViewService().createNode(
        ...
        WebspecmodelVisualIDRegistry
            .getType(OneOfNumbersNameEditPart.VISUAL_ID), ViewUtil.APPEND,
