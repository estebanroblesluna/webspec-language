...
import org.webspeclanguage.plugin.webspecmodel.diagram.edit.parts.WrappingLabelEditPart;
 ...
 * @generated
 */
public class RIAFeatureViewFactory extends AbstractShapeViewFactory {
  ...
  protected void decorateView(View containerView, View view,
    ...
    if (semanticHint == null) {
      semanticHint = WebspecmodelVisualIDRegistry
          .getType(RIAFeatureEditPart.VISUAL_ID);
    ...
    getViewService().createNode(eObjectAdapter, view,
        WebspecmodelVisualIDRegistry.getType(WrappingLabelEditPart.VISUAL_ID),
