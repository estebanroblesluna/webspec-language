...
public class Emf2CoreTransformation {
	...
	private Map<org.webspeclanguage.plugin.webspecmodel.Interaction, InteractionImpl> interactionConvertions;
	private Map<org.webspeclanguage.plugin.webspecmodel.Transition, TransitionImpl> transitionConvertions;
	private DiagramImpl webSpecDiagram;
	private Set<String> generatorsDeclared;
	private Set<String> generatorsUsed;
	
	public TransformationResult transform(org.webspeclanguage.plugin.webspecmodel.Diagram diagram) {
  ...
  private DiagramImpl createDiagramFrom(org.webspeclanguage.plugin.webspecmodel.Diagram diagram) {
	...
	private void createGenerators(org.webspeclanguage.plugin.webspecmodel.Diagram diagram) {
		...
		for (Object obj : diagram.getGenerators()) {
			...
			try {
				if (generator instanceof org.webspeclanguage.plugin.webspecmodel.OneOfNumbers) {
					org.webspeclanguage.plugin.webspecmodel.OneOfNumbers generatorC = (org.webspeclanguage.plugin.webspecmodel.OneOfNumbers) generator;
				...
				} else if (generator instanceof org.webspeclanguage.plugin.webspecmodel.OneOfStrings) {
					org.webspeclanguage.plugin.webspecmodel.OneOfStrings generatorC = (org.webspeclanguage.plugin.webspecmodel.OneOfStrings) generator;
				...
				} else if (generator instanceof org.webspeclanguage.plugin.webspecmodel.UniformNumberDistribution) {
					org.webspeclanguage.plugin.webspecmodel.UniformNumberDistribution generatorC = (UniformNumberDistribution) generator; 
					webSpecGenerator = new UniformNumberGenerator(generatorC.getName(), generatorC.getMin(), generatorC.getMax());
					
				} else if (generator instanceof org.webspeclanguage.plugin.webspecmodel.StringGenerator) {
					org.webspeclanguage.plugin.webspecmodel.StringGenerator generatorC = (org.webspeclanguage.plugin.webspecmodel.StringGenerator) generator;
					webSpecGenerator = new RandomStringGenerator(generatorC.getName(), generatorC.getMaxLength());
					
				} else if (generator instanceof org.webspeclanguage.plugin.webspecmodel.OneOfArray) {
					org.webspeclanguage.plugin.webspecmodel.OneOfArray generatorC = (org.webspeclanguage.plugin.webspecmodel.OneOfArray) generator; 
	...
	private void createTransitionsPreconditionsAndActions(org.webspeclanguage.plugin.webspecmodel.Diagram diagram) {
		for (Object obj : diagram.getTransitions()) {
		  org.webspeclanguage.plugin.webspecmodel.Transition transition = (org.webspeclanguage.plugin.webspecmodel.Transition) obj;
	...
	private void createInteractionInvariants(org.webspeclanguage.plugin.webspecmodel.Diagram diagram) {
		for (Object obj : diagram.getInteractions()) {
		  org.webspeclanguage.plugin.webspecmodel.Interaction interaction = (org.webspeclanguage.plugin.webspecmodel.Interaction) obj;
	...
	private void createTransitions(org.webspeclanguage.plugin.webspecmodel.Diagram diagram) {
		transitionConvertions = new HashMap<org.webspeclanguage.plugin.webspecmodel.Transition, TransitionImpl>();
	...
	private void createInteractionsAndWidgets(org.webspeclanguage.plugin.webspecmodel.Diagram diagram) {
		interactionConvertions = new HashMap<org.webspeclanguage.plugin.webspecmodel.Interaction, InteractionImpl>();
		...
		for (Object obj : diagram.getInteractions()) {
	      ...
	      this.addError("Widget " + e.getWidgetName() + " in interaction title " + e.getInteractionName() + " not found");
			...
			for (Object obj2 : interaction.getRoot().getWidgets()) {
			  org.webspeclanguage.plugin.webspecmodel.Widget widget = (org.webspeclanguage.plugin.webspecmodel.Widget) obj2;
	...
	private void transformWidgetInto(org.webspeclanguage.plugin.webspecmodel.Widget widget, Container container, Interaction webSpecInteraction) {
		Widget webspecWidget = null;
		
		if (widget instanceof org.webspeclanguage.plugin.webspecmodel.Button) {
			webspecWidget = new Button();
		} else if (widget instanceof org.webspeclanguage.plugin.webspecmodel.CheckBox) {
			webspecWidget = new CheckBox();
		} else if (widget instanceof org.webspeclanguage.plugin.webspecmodel.ComboBox) {
			webspecWidget = new ComboBox();
		} else if (widget instanceof org.webspeclanguage.plugin.webspecmodel.ListBox) {
			webspecWidget = new ListBox();
		} else if (widget instanceof org.webspeclanguage.plugin.webspecmodel.RadioButton) {
			webspecWidget = new RadioButton();
		} else if (widget instanceof org.webspeclanguage.plugin.webspecmodel.TextField) {
			webspecWidget = new TextField();
		} else if (widget instanceof org.webspeclanguage.plugin.webspecmodel.Link) {
			webspecWidget = new Link();
		} else if (widget instanceof org.webspeclanguage.plugin.webspecmodel.Label) {
			webspecWidget = new Label();
		} else if (widget instanceof org.webspeclanguage.plugin.webspecmodel.ListOfContainer) {
			webspecWidget = new ListOfContainer();
		} else if (widget instanceof org.webspeclanguage.plugin.webspecmodel.PanelContainer) {
		...
		if (webspecWidget instanceof Container) {
			org.webspeclanguage.plugin.webspecmodel.Container c = (org.webspeclanguage.plugin.webspecmodel.Container) widget;
			for (Object o2 : c.getWidgets()) {
			  org.webspeclanguage.plugin.webspecmodel.Widget w = (org.webspeclanguage.plugin.webspecmodel.Widget) o2;
