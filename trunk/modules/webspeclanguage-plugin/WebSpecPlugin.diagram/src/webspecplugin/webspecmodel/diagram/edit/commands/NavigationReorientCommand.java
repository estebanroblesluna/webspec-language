...
import webspecplugin.webspecmodel.diagram.edit.policies.WebspecmodelBaseItemSemanticEditPolicy;

/**
 * @generated
 */
public class NavigationReorientCommand extends EditElementCommand {
   ...
   * @generated
   */
  public NavigationReorientCommand(ReorientRelationshipRequest request) {
  ...
  public boolean canExecute() {
    if (false == getElementToEdit() instanceof Navigation) {
      return false;
    }
  ...
  protected boolean canReorientSource() {
    ...
    return WebspecmodelBaseItemSemanticEditPolicy.LinkConstraints.canExistNavigation_4001(container, getNewSource(), target);
  }
  ...
  protected boolean canReorientTarget() {
    ...
    Diagram container = (Diagram) getLink().eContainer();
    return WebspecmodelBaseItemSemanticEditPolicy.LinkConstraints.canExistNavigation_4001(container, source, getNewTarget());
  }
   ...
   * @generated
   */
  protected Navigation getLink() {
    return (Navigation) getElementToEdit();
  }
