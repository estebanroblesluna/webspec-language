...
public class RadioButtonCreateCommand extends EditElementCommand {
  ...
  protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
    RadioButton newElement = WebspecmodelFactory.eINSTANCE.createRadioButton();
   ...
   * @generated
   */
  protected void doConfigure(RadioButton newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
