 ...
 * @generated
 */
public class OneOfStringsCreateCommand extends EditElementCommand {

  /**
   * @generated
   */
  public OneOfStringsCreateCommand(CreateElementRequest req) {
  ...
  protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
    OneOfStrings newElement = WebspecmodelFactory.eINSTANCE.createOneOfStrings();
   ...
   * @generated
   */
  protected void doConfigure(OneOfStrings newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
