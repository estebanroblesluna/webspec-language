...
public class BalsamiqWidgetParserTestCase extends WidgetParserTestCase {
  ...
  public void testModelTranslation() throws Exception{
    SuiModel m = this.getBalsamiqTranslator().translateModelFrom(
      ...
      (Mockup<String>)
      new Mockup<String>(
        FileUtils.readFileToString(new File("src/test/resources/org/webspeclanguage/mockupdd/translator/balsamiq/model.bmml")),
        new MockupContainerInfo("balsamiqModel", "file://src/test/resources/org/webspeclanguage/mockupdd/translator/balsamiq/model.bmml/"))));
