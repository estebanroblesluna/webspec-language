 ...
 */
public class ButtonParser implements SuiParser<Element, SuiParserContext>  {
  ...
  public Object parse(Element source, SuiParserContext parserContext, Object partiallyParsedObject) throws SuiParsingException {
    return parserContext.buildWidget(Button.class, source, source.getAttributeValue("label"));
  }
