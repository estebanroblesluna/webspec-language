 ...
 */
public abstract interface UIControl extends MetaMockElement {
  ...
  CompositeControl getParent();

  void setParent(CompositeControl c);
   ...
   */
  Boolean isTheSameAs(CompositeControl parent);
