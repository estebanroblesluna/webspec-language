 ...
 */
public class ButtonImpl extends SimpleWidgetImpl implements Button {

  private String text;

  public ButtonImpl(String widgetID, Integer x, Integer y, Integer width, Integer height, String text) {
  ...
  public Widget copyConcreteWidget() {
    return new ButtonImpl(this.getWidgetId(), this.getX(), this.getY(), this.getWidth(), this.getHeight(), this.getText());
  }
