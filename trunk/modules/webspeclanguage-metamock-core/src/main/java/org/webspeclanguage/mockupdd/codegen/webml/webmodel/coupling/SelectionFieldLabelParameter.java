 ...
 */
public class SelectionFieldLabelParameter extends SelectionFieldInputParameter {

  public SelectionFieldLabelParameter(String id, String name, SelectionField selectionField) {
