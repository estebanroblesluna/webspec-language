 ...
 */
public class TextBoxImpl extends SimpleControlImpl implements TextBox {

  public TextBoxImpl(String controlID, Integer x, Integer y, Integer width, Integer height) {
  ...
  public Widget copyConcreteControl() {
    return new TextBoxImpl(this.getControlId(), this.getX(), this.getY(), this.getWidth(), this.getHeight());
  }
}
