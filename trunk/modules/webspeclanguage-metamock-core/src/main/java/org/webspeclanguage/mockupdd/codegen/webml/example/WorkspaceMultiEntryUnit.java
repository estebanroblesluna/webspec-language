 ...
 */
public class WorkspaceMultiEntryUnit {
  ...
  public static void main(String[] args) {
    ...
    MultiEntryUnit multientryUnit = webFactory.createMultiEntryUnit("multientryunit1", entD1);
    ...
    multientryUnit.addField(nf1);
    multientryUnit.addField(nf2);
    multientryUnit.addField(nf3);
    multientryUnit.addField(sf1);
    
    HashMap<String,Parameter> parametersInput = multientryUnit.getInputParameters();
    ...
    HashMap<String,Parameter> parametersOutput = multientryUnit.getOutputParameters();
