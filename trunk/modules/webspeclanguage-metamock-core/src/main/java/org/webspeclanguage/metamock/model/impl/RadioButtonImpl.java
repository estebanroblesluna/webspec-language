 ...
 */
public class RadioButtonImpl extends SimpleControlImpl implements RadioButton {

  private String text;

  public RadioButtonImpl(String controlID, Integer x, Integer y, Integer width, Integer height, String text) {
  ...
  public Boolean equalInContent(UIControl control) {
    RadioButton other = (RadioButton) control;
