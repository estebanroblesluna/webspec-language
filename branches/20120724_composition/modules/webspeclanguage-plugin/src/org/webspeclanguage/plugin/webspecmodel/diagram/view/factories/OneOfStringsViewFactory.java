 ...
 * @generated
 */
public class OneOfStringsViewFactory extends AbstractShapeViewFactory {
  ...
  protected void decorateView(View containerView, View view,
    ...
    if (semanticHint == null) {
      semanticHint = WebspecmodelVisualIDRegistry
          .getType(OneOfStringsEditPart.VISUAL_ID);
    ...
    getViewService().createNode(
        ...
        WebspecmodelVisualIDRegistry
            .getType(OneOfStringsNameEditPart.VISUAL_ID), ViewUtil.APPEND,
