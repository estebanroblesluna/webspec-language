...
import org.webspeclanguage.plugin.webspecmodel.diagram.edit.policies.LinkItemSemanticEditPolicy;
...
public class LinkEditPart extends ShapeNodeEditPart {
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof LinkNameEditPart) {
      ((LinkNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureWidgetName());
      return true;
    }
    return false;
  }
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(WebspecmodelVisualIDRegistry.getType(LinkNameEditPart.VISUAL_ID));
  }
