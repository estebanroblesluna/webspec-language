...
import org.webspeclanguage.plugin.webspecmodel.diagram.edit.policies.ComboBoxItemSemanticEditPolicy;
...
public class ComboBoxEditPart extends ShapeNodeEditPart {
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof ComboBoxNameEditPart) {
      ((ComboBoxNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureWidgetName());
      return true;
    }
    return false;
  }
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(WebspecmodelVisualIDRegistry.getType(ComboBoxNameEditPart.VISUAL_ID));
  }
