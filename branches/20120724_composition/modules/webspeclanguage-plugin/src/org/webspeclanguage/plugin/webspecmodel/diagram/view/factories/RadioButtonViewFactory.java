 ...
 * @generated
 */
public class RadioButtonViewFactory extends AbstractShapeViewFactory {
  ...
  protected void decorateView(View containerView, View view,
    ...
    if (semanticHint == null) {
      semanticHint = WebspecmodelVisualIDRegistry
          .getType(RadioButtonEditPart.VISUAL_ID);
    ...
    getViewService()
        .createNode(
            ...
            WebspecmodelVisualIDRegistry
                .getType(RadioButtonNameEditPart.VISUAL_ID), ViewUtil.APPEND,
