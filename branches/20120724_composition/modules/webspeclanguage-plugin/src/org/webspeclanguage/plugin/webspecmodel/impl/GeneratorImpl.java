 ...
 * <ul>
 *   <li>{@link org.webspeclanguage.plugin.webspecmodel.impl.GeneratorImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GeneratorImpl extends EObjectImpl implements Generator {
	...
	protected EClass eStaticClass() {
		return WebspecmodelPackage.Literals.GENERATOR;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebspecmodelPackage.GENERATOR__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebspecmodelPackage.GENERATOR__NAME:
				return getName();
		}
