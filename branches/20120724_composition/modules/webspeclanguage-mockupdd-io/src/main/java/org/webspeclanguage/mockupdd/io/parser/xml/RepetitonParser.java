 ...
 */
public class RepetitonParser implements SuiParser<Element, SuiParserContext> {
  ...
  public Object parse(Element source, SuiParserContext parserContext, Object partiallyParsedObject) throws SuiParsingException {
    return parserContext.buildWidget(Repetition.class, source, new ArrayList<Widget>(), 1, 1, "");
  }
