 ...
 */
public class DefaultRepetitionDetectorImpl implements RepetitionDetector {
	...
	public DefaultRepetitionDetectorImpl(SuiFactory factory, Integer pixelTolerance, Integer minWidgets) {
		super();
	...
	public DefaultRepetitionDetectorImpl(SuiFactory factory) {
