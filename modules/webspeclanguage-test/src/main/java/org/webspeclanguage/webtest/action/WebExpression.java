...
/**
 * An expression as an action
 * 
 * @author Esteban Robles Luna
 */
public class WebExpression implements WebAction {

  private Expression expression;

  public WebExpression(Expression expression) {
  ...
  public Object accept(WebTestItemVisitor webTestItemVisitor) {
    return webTestItemVisitor.visitWebExpression(this);
  }
