...
public class VerticalBoxLayoutAnnotationImpl extends SuiAnnotationImpl implements VerticalBoxLayoutAnnotation {

  public VerticalBoxLayoutAnnotationImpl(Widget widget) {
    super(widget);
  }
