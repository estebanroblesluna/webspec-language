 ...
 */
public class PageParser implements SuiParser<Element, SuiParserContext> {
  ...
  public Object parse(Element source, SuiParserContext parserContext, Object partiallyParsedObject) throws SuiParsingException {
    return parserContext.buildWidget(Page.class, source, source.getAttributeValue("title"), "");
  }
