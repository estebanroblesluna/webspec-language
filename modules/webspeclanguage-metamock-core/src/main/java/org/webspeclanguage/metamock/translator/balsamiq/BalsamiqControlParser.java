...
/**
 * {@link MetaMockControlParser} implementation for parsing mockup controls from
 * Balsamiq files
 * 
 * @author Jose Matias Rivero
 */
public class BalsamiqControlParser implements MetaMockControlParser<String> {
  ...
  public final Collection<MetaMockControlGroup> parseControls(String source) throws MockupSourceParsingException {
    DefaultMetaMockControlGroupImpl group = new DefaultMetaMockControlGroupImpl(new ArrayList<UIControl>());
    ...
    return new ArrayList<MetaMockControlGroup>(Arrays.asList(new MetaMockControlGroup[] { group }));
  }
