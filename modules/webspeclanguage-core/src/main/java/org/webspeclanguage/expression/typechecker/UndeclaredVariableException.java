...
/**
 * An exception thrown when a variables is undeclared
 * 
 * @author Esteban Robles Luna
 */
public class UndeclaredVariableException extends RuntimeException {

  private static final long serialVersionUID = 3608612289244946571L;
  ...
  public String getMessage() {
    return "Variable: " + this.getVariableName() + " is undeclared";
  }
