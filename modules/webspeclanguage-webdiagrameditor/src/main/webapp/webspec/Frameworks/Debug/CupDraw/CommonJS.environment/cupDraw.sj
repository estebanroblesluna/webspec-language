...
p;14;DrawingModel.jt;721;@STATIC;1.0;t;703;{var the_class = objj_allocateClassPair(Model, "DrawingModel"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
...
{ with(self)
{
 ...
 objj_msgSend(self, "addProperty:value:",  "Show grid?",  YES);
...
objj_registerClassPair(the_class);
class_addMethods(the_class, [new objj_method(sel_getUid("initWithSource:target:"), function $Connection__initWithSource_target_(self, _cmd, aSourceFigure, aTargetFigure)
{ with(self)
{
