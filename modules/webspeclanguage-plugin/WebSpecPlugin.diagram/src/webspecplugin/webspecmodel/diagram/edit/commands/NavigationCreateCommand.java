 ...
 * @generated
 */
public class NavigationCreateCommand extends EditElementCommand {
   ...
   * @generated
   */
  public NavigationCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
  ...
  public boolean canExecute() {
    ...
    return WebspecmodelBaseItemSemanticEditPolicy.LinkConstraints.canCreateNavigation_4001(getContainer(), getSource(), getTarget());
  }
  ...
  protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
    ...
    Navigation newElement = WebspecmodelFactory.eINSTANCE.createNavigation();
   ...
   * @generated
   */
  protected void doConfigure(Navigation newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
