 ...
 * @generated
 */
public class ListBoxCreateCommand extends EditElementCommand {

  /**
   * @generated
   */
  public ListBoxCreateCommand(CreateElementRequest req) {
  ...
  protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
    ListBox newElement = WebspecmodelFactory.eINSTANCE.createListBox();
   ...
   * @generated
   */
  protected void doConfigure(ListBox newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
