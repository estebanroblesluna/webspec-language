 ...
 * @generated
 */
public class UniformNumberDistributionViewFactory extends
  ...
  protected void decorateView(View containerView, View view,
    ...
    if (semanticHint == null) {
      semanticHint = WebspecmodelVisualIDRegistry
          .getType(UniformNumberDistributionEditPart.VISUAL_ID);
    ...
    getViewService().createNode(
        ...
        WebspecmodelVisualIDRegistry
            .getType(UniformNumberDistributionNameEditPart.VISUAL_ID),
