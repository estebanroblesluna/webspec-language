...
/**
 * This is the item provider adapter for a {@link webspecplugin.webspecmodel.Widget} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebspecmodelPackage.Literals.WIDGET__NAME,
				 true,
				 false,
				 false,
	...
	protected void addLocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Widget_location_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Widget_location_feature", "_UI_Widget_type"),
				 WebspecmodelPackage.Literals.WIDGET__LOCATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
