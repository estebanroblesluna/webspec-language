...
import org.webspeclanguage.plugin.webspecmodel.diagram.edit.parts.NavigationPreconditionActionsEditPart;
 ...
 * @generated
 */
public class NavigationViewFactory extends ConnectionViewFactory {
  ...
  protected void decorateView(View containerView, View view,
    ...
    if (semanticHint == null) {
      semanticHint = WebspecmodelVisualIDRegistry
          .getType(NavigationEditPart.VISUAL_ID);
    ...
    getViewService().createNode(
        ...
        WebspecmodelVisualIDRegistry
            .getType(NavigationPreconditionActionsEditPart.VISUAL_ID),
