package org.webspeclanguage.plugin.webspecmodel.diagram.parsers;
...
public class MessageFormatParser extends AbstractParser {
  ...
  public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
    ...
    if (values == null) {
      return new ParserEditStatus(WebspecmodelDiagramEditorPlugin.ID, IParserEditStatus.UNEDITABLE, NLS.bind(Messages.MessageFormatParser_InvalidInputError,
