...
import org.webspeclanguage.plugin.webspecmodel.diagram.edit.policies.LabelItemSemanticEditPolicy;
...
public class LabelEditPart extends ShapeNodeEditPart {
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof LabelNameEditPart) {
      ((LabelNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureWidgetName());
      return true;
    }
    return false;
  }
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(WebspecmodelVisualIDRegistry.getType(LabelNameEditPart.VISUAL_ID));
  }
