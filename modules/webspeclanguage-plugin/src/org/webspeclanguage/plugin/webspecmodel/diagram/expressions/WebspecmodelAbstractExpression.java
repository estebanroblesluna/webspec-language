package org.webspeclanguage.plugin.webspecmodel.diagram.expressions;
 ...
 * @generated
 */
public abstract class WebspecmodelAbstractExpression {
  ...
  protected void setStatus(int severity, String message, Throwable throwable) {
    String pluginID = WebspecmodelDiagramEditorPlugin.ID;
    this.status = new Status(severity, pluginID, -1,
        (message != null) ? message : "", throwable); //$NON-NLS-1$
    if (!this.status.isOK()) {
      WebspecmodelDiagramEditorPlugin.getInstance().logError(
   ...
   * @generated
   */
  protected WebspecmodelAbstractExpression(String body, EClassifier context) {
    myBody = body;
    myContext = context;
  }
