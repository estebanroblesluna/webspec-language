...
import org.webspeclanguage.plugin.webspecmodel.diagram.edit.policies.CheckBoxItemSemanticEditPolicy;
...
public class CheckBoxEditPart extends ShapeNodeEditPart {
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof CheckBoxNameEditPart) {
      ((CheckBoxNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureWidgetName());
      return true;
    }
    return false;
  }
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(WebspecmodelVisualIDRegistry.getType(CheckBoxNameEditPart.VISUAL_ID));
  }
