...
import org.webspeclanguage.plugin.webspecmodel.diagram.edit.parts.RichBehaviorPreconditionActionsEditPart;
 ...
 * @generated
 */
public class RichBehaviorViewFactory extends ConnectionViewFactory {
  ...
  protected void decorateView(View containerView, View view,
    ...
    if (semanticHint == null) {
      semanticHint = WebspecmodelVisualIDRegistry
          .getType(RichBehaviorEditPart.VISUAL_ID);
    ...
    getViewService().createNode(
        ...
        WebspecmodelVisualIDRegistry
            .getType(RichBehaviorPreconditionActionsEditPart.VISUAL_ID),
