 ...
 * @generated
 */
public class OneOfNumbersCreateCommand extends EditElementCommand {

  /**
   * @generated
   */
  public OneOfNumbersCreateCommand(CreateElementRequest req) {
  ...
  protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
    OneOfNumbers newElement = WebspecmodelFactory.eINSTANCE.createOneOfNumbers();
   ...
   * @generated
   */
  protected void doConfigure(OneOfNumbers newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
