 ...
 * @generated
 */
public class RichBehaviorPreconditionActionsEditPart extends LabelEditPart
  ...
  static {
    registerSnapBackPosition(
        WebspecmodelVisualIDRegistry
            .getType(org.webspeclanguage.plugin.webspecmodel.diagram.edit.parts.RichBehaviorPreconditionActionsEditPart.VISUAL_ID),
        new Point(0, 40));
  }
   ...
   * @generated
   */
  public RichBehaviorPreconditionActionsEditPart(View view) {
    super(view);
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      ...
      IAdaptable hintAdapter = new WebspecmodelParserProvider.HintAdapter(
          WebspecmodelElementTypes.RichBehavior_4002, getParserElement(),
          parserHint);
  ...
  protected DirectEditManager getManager() {
    if (manager == null) {
      setManager(new TextDirectEditManager(this, TextDirectEditManager
          .getTextCellEditorClass(this), WebspecmodelEditPartFactory
