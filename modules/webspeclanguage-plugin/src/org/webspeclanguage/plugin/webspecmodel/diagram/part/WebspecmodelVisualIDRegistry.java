...
public class WebspecmodelVisualIDRegistry {
  ...
  public static int getVisualID(View view) {
    ...
    return org.webspeclanguage.plugin.webspecmodel.diagram.part.WebspecmodelVisualIDRegistry.getVisualID(view.getType());
  }
  ...
  public static int getDiagramVisualID(EObject domainElement) {
    ...
    if (WebspecmodelPackage.eINSTANCE.getDiagram().isSuperTypeOf(domainElement.eClass()) && isDiagram((org.webspeclanguage.plugin.webspecmodel.Diagram) domainElement)) {
      return DiagramEditPart.VISUAL_ID;
    }
    return -1;
  }
  ...
  public static int getNodeVisualID(View containerView, EObject domainElement) {
    ...
    String containerModelID = org.webspeclanguage.plugin.webspecmodel.diagram.part.WebspecmodelVisualIDRegistry.getModelID(containerView);
    if (!DiagramEditPart.MODEL_ID.equals(containerModelID)) {
      return -1;
    }
    int containerVisualID;
    if (DiagramEditPart.MODEL_ID.equals(containerModelID)) {
      containerVisualID = org.webspeclanguage.plugin.webspecmodel.diagram.part.WebspecmodelVisualIDRegistry.getVisualID(containerView);
    } else {
   ...
   * @generated
   */
  private static boolean isDiagram(org.webspeclanguage.plugin.webspecmodel.Diagram element) {
    return true;
  }
