...
import org.webspeclanguage.plugin.webspecmodel.diagram.edit.policies.RadioButtonItemSemanticEditPolicy;
...
public class RadioButtonEditPart extends ShapeNodeEditPart {
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof RadioButtonNameEditPart) {
      ((RadioButtonNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureWidgetName());
      return true;
    }
    return false;
  }
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(WebspecmodelVisualIDRegistry.getType(RadioButtonNameEditPart.VISUAL_ID));
  }
