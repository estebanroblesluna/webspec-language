...
import org.webspeclanguage.plugin.webspecmodel.diagram.edit.policies.ButtonItemSemanticEditPolicy;
...
public class ButtonEditPart extends ShapeNodeEditPart {
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof ButtonNameEditPart) {
      ((ButtonNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureWidgetName());
      return true;
    }
    return false;
  }
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(WebspecmodelVisualIDRegistry.getType(ButtonNameEditPart.VISUAL_ID));
  }
