 ...
 */
public class LinkImpl extends SimpleWidgetImpl implements Link {

  private String text;

  public LinkImpl(String widgetID, Integer x, Integer y, Integer width, Integer height, String text) {
  ...
  public Boolean equalInContent(Widget widget) {
    Link other = (Link) widget;
    return super.equalInContent(other) && this.getText().equals(other.getText());
  }

  @Override
  public Widget copyConcreteWidget() {
    return new LinkImpl(this.getWidgetId(), this.getX(), this.getY(), this.getWidth(), this.getHeight(), this.getText());
  }
